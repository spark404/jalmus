...
public class Rhythm {
    ...
    int getYpos(ScoreLevel sl, int p) {
        ...
        } else if (this.samenotePitch(2, p)) {
        ...
        } else if (this.samenotePitch(4, p)) {
            noteY = (64 - p) * 35 / 12 + 33 + keyoffset;
        } else if (this.samenotePitch(5, p)) {
        ...
        } else if (this.samenotePitch(7, p)) {
        ...
        } else if (this.samenotePitch(9, p)) {
        ...
        } else if (this.samenotePitch(11, p)) {
