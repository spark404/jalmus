...
public class Chord {
    ...
    public void paint(int position, NoteLevel nrlevel, Graphics g, Font f, boolean accordcourant, Component j, int dportee, ResourceBundle bundle) {
        ...
        if (accordcourant) {
            tabnotes[this.realposition(position)]
                    .paint(nrlevel, g, f, this.getNoteposition(this.realposition(position), nrlevel.getCurrentTonality(), bundle), 0, dportee, j, c, bundle);
        }
