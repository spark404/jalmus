...
public class Lessons extends DefaultHandler {
    ...
    boolean inExercices, inNLevel, inRLevel, inSLevel, inGametype, inNotestype, inNbnotes, inMessage, inSpeed, inStartingnote, inClef, inTonality, inIntervals, inChords,
            inDuration, inPitches, inRhythms, inTime, inRests, inTuplets, inMetronome;
 ...
 ************************************************************************/
            ...
            case SCORELEVEL:
                ...
                while (sts.hasMoreTokens()) {
                    ps = Integer.parseInt(sts.nextToken());
                    if (ps == 1 && slevel.getTimeSignNumerator() == 4 && slevel.getTimeSignDenominator() == 4) {
                        slevel.setWholeNote(true);
                    } else if (ps == 2) {
                        slevel.setHalfNote(true);
                    } else if (ps == 3 && slevel.getTimeSignNumerator() >= 3 && slevel.getTimeSignDenominator() == 4) {
                        ...
                        throw new SAXException("In level " + slevel.getId() + " rhythms should be 1, 2, 3, 4, 8  ");
                    }
            ...
            case RHYTHMLEVEL:
                ...
                while (st.hasMoreTokens()) {
                    ...
                    if (p == 1) {
                        ...
                        throw new SAXException("In level " + rlevel.getId() + " rests should be 1, 2, 3, 4, 8  ");
                    }
            ...
            case SCORELEVEL:
                ...
                while (sts.hasMoreTokens()) {
                    ...
                    if (ps == 1) {
                        ...
                        throw new SAXException("In level " + slevel.getId() + " rests should be 1, 2, 3, 4, 8  ");
                    }
