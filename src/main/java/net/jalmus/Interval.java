...
public class Interval {
    ...
    public void copy(Interval a) {
        this.interv[0] = new Note(a.interv[0].getAlteration(), a.interv[0].getNom(), a.interv[0].getHeight(), a.interv[0].getX(), a.interv[0].getPitch());
        this.interv[1] = new Note(a.interv[1].getAlteration(), a.interv[1].getNom(), a.interv[1].getHeight(), a.interv[1].getX(), a.interv[1].getPitch());
        this.name = a.name;
    }
    ...
    public void paint(int position, NoteLevel nrlevel, Graphics g, Font f, int dportee, ResourceBundle bundle, boolean intervcourant, Component j) {
