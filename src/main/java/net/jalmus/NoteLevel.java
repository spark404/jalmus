...
public class NoteLevel implements Level {
    ...
    /* For learning game only */ int learningduration; // duration of learning game in lesson mode

    /* For notes game only */ int nbnotes; // number of notes : 0 for all notes, 3, 5, 7, 9 or 15
    ...
    /* For interval game only*/ String intervaltype;
...
/*****************************************/
    ...
    public void save(Lessons l, String fileName, String message, String language) throws IOException {
    ...
    public void basenotetoLeft(Piano piano) {  //base note is move when user pres key left
        ...
        //jusqu'� do
            ...
            if (piano.is73keys() & ((this.nbnotesupper == 7 & basebass < 50) | (this.nbnotesupper == 4 & basebass < 65) | (this.nbnotesupper == 3 & basebass < 60) | (
                    this.nbnotesupper == 2 & basebass < 75) | (this.nbnotesupper == 1 & basebass < 80))) {
                basebass = basebass + 5; //fa = 17kw

            }

            if (piano.is61keys() & ((this.nbnotesupper == 7 & basebass < 15) | (this.nbnotesupper == 4 & basebass < 30) | (this.nbnotesupper == 3 & basebass < 35) | (
                    this.nbnotesupper == 2 & basebass < 40) | (this.nbnotesupper == 1 & basebass < 45))) {
                basebass = basebass + 5; //fa = 17kw

            }

        } else if (this.isCurrentKeyBoth()) {
            if (piano.is73keys() & ((this.nbnotesupper == 7 & this.basetreble < 15) | (this.nbnotesupper == 4 & this.basetreble < 30) | (this.nbnotesupper == 3
                    & this.basetreble < 35) | (this.nbnotesupper == 2 & this.basetreble < 40) | (this.nbnotesupper == 1 & this.basetreble < 45))) {
                basebass = basebass + 5;
                this.basetreble = this.basetreble + 5;

            }

            if (piano.is61keys() & ((this.nbnotesupper == 7 & this.basetreble < 5) | (this.nbnotesupper == 4 & this.basetreble < 20) | (this.nbnotesupper == 3
                    & this.basetreble < 25) | (this.nbnotesupper == 2 & this.basetreble < 30) | (this.nbnotesupper == 1 & this.basetreble < 35))) {
                basebass = basebass + 5;
                this.basetreble = this.basetreble + 5;
    ...
    public void basenotetoRight(Piano piano) {
        ...
        if (this.isCurrentKeyTreble()) {
            ...
            if ((this.nbnotesupper == 7 & this.basebass > -20) | (this.nbnotesupper == 4 & this.basebass > -35) | (this.nbnotesupper == 3 & this.basebass > -40) // 5 notes
                    | (this.nbnotesupper == 2 & this.basebass > -45) | (this.nbnotesupper == 1 & this.basebass > -50)) {
    ...
    public boolean moveBasenote(int range) {
        if (range != 0) {
            ...
            if (this.isCurrentKeyTreble()) {
                ...
                if ((this.nbnotes == 15 & ((range > 0 & range <= 1) | (range < 0 & Math.abs(range) <= 1))) | (this.nbnotes == 9 & ((range > 0 & range <= 4) | (range < 0
                        & Math.abs(range) <= 4))) | (this.nbnotes == 7 & ((range > 0 & range <= 5) | (range < 0 & Math.abs(range) <= 5))) | (this.nbnotes == 5 & (
                        (range > 0 & range <= 6) | (range < 0 & Math.abs(range) <= 6))) | (this.nbnotes == 3 & ((range > 0 & range <= 7) | (range < 0 & Math.abs(range) <= 7)))) {
                    this.basebass = this.basebass - 5 * range;
                    this.basetreble = this.basetreble - 5 * range;
                    return true;
                } else {
