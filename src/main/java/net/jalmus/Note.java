...
//System.out.println(this.Alteration);
    ...
    public void updateNotePitch(NoteLevel nrlevel, int dportee, ResourceBundle bundle) {
        ...
        if (nrlevel.isCurrentKeyTreble() || (nrlevel.isCurrentKeyBoth() & this.Pitch >= 57)) {//base cl� de sol : SOL = dportee+25
            ...
            if (this.samenotePitch(0)) {
                this.Nom = DO;
                this.Height = (60 - this.Pitch) * 35 / 12 + dportee - 15 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
                ...
                if (nrlevel.getCurrentTonality().isflat()) {
                    this.Nom = RE;
                    this.Height = (61 - this.Pitch) * 35 / 12 + dportee - 20 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "b";
                    ...
                    this.Nom = DO;
                    this.Height = (61 - this.Pitch) * 35 / 12 + dportee - 15 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "#";
                ...
                this.Nom = RE;
                this.Height = (62 - this.Pitch) * 35 / 12 + dportee - 20 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
                ...
                if (nrlevel.getCurrentTonality().issharp()) {
                    this.Nom = RE;
                    this.Height = (63 - this.Pitch) * 35 / 12 + dportee - 20 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "#";
                    ...
                    this.Nom = MI;
                    this.Height = (63 - this.Pitch) * 35 / 12 + dportee - 25 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "b";
                ...
                this.Nom = MI;
                this.Height = (64 - this.Pitch) * 35 / 12 + dportee - 25 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
                ...
                this.Nom = FA;
                this.Height = (65 - this.Pitch) * 35 / 12 + dportee - 30 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
                ...
                if (nrlevel.getCurrentTonality().issharp()) {
                    this.Nom = FA;
                    this.Height = (66 - this.Pitch) * 35 / 12 + dportee - 30 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "#";
                    ...
                    this.Nom = SOL;
                    this.Height = (66 - this.Pitch) * 35 / 12 + dportee - 35 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "b";
                ...
                this.Nom = SOL;
                this.Height = (67 - this.Pitch) * 35 / 12 + dportee - 35 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
                ...
                if (nrlevel.getCurrentTonality().issharp()) {
                    this.Nom = SOL;
                    this.Height = (68 - this.Pitch) * 35 / 12 + dportee - 35 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "#";
                    ...
                    this.Nom = LA;
                    this.Height = (68 - this.Pitch) * 35 / 12 + dportee - 40 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "b";
                ...
                this.Nom = LA;
                this.Height = (69 - this.Pitch) * 35 / 12 + dportee - 40 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
                ...
                if (nrlevel.getCurrentTonality().isflat()) {
                    this.Nom = SI;
                    this.Height = (70 - this.Pitch) * 35 / 12 + dportee - 45 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "b";
                    ...
                    this.Nom = LA;
                    this.Height = (70 - this.Pitch) * 35 / 12 + dportee - 40 + heigth2staff;
                    if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                        this.Alteration = "";
                    } else {
                        this.Alteration = "#";
                ...
                this.Nom = SI;
                this.Height = (71 - this.Pitch) * 35 / 12 + dportee - 45 + heigth2staff;
                if (accidentalInTonality(nrlevel.getCurrentTonality(), bundle)) {
                    this.Alteration = "n";
                } else {
                    this.Alteration = "";
