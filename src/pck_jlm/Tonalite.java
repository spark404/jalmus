...
public class Tonalite {
  ...
  public Tonalite(int nb, String alt) {
    this.Alteration = alt;
    this.Nbalt = nb;
  }
  ...
  public void paint(String cle, Graphics g, int marge, int dportee, Tabimage tab, Component j, ResourceBundle bundle) {
    int i = 0;
    int decalagecle = 0;
    boolean ok = false;
